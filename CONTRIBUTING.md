...
Thank you for taking the time to look at Synheart Behavior (Android). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-behavior-kotlin/issues) to avoid
   duplicates.
